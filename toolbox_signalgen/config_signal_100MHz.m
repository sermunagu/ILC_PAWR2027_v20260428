...
info_signal.NPRB = 135;      % Número de PRBs activos. Cada PRB contiene 12 
...
info_signal.BW = 100e6;      % Ancho de banda de la canalizacion en Hz 
...
info_signal.ovs = 5;        % Factor de sobremuestreo, entero.
