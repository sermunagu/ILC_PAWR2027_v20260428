...
% O bien
info_signal.Df = 30e3;
info_signal.M = 64;         % Número de símbolos de la constelación M-QAM  
% mapeada sobre todos los símbolos OFDM. Potencia de 2 y constelación cuadrada.
info_signal.NPRB = 51;      % Número de PRBs activos. Cada PRB contiene 12 
...
info_signal.BW = 20e6;      % Ancho de banda de la canalizacion en Hz 
% No es el ocupado efectivo. Valores posibles
% [5e6 10e6 15e6 20e6 25e6 30e6 40e6 50e6 60e6 80e6 100e6]
info_signal.Nslots = 8;     % Numero de slots a contemplar. 
...
info_signal.centralSC = 1; % Bandera indicando si la subportadora central lleva información o no.
